...
import { LOGIN_PREFIX, PUBLIC_PREFIX, ERROR_PREFIX, SIGNUP_PREFIX, PROFILE_PREFIX, PRODUCT_DETAIL_PREFIX, CART_PREFIX, SHIPPING_PREFIX, FORWARDING_PREFIX, WAREHOUSE_PREFIX, PARCEL_PREFIX, INTERNATIONAL_PREFIX, AFILLIATE_PREFIX, CHECKOUT_PREFIX, CALCULATOR_PREFIX, SEARCH_PREFIX, MANUAL_PREFIX, BANK_PREFIX, MANUAL_PRODUCT_DETAIL_PREFIX, HISTORY_PREFIX, HISTORYCART_PREFIX, CONFIRM_PREFIX } from 'configs/app-config';
...
export default function PublicPage() {
    return (
        <Switch>
            ...
            <Route exact path={PUBLIC_PREFIX + SHIPPING_PREFIX} component={Shipping} />
            ...
            <Route exact path={PUBLIC_PREFIX + FORWARDING_PREFIX} component={ForwardingPage} />
            <Route exact path={PUBLIC_PREFIX + AFILLIATE_PREFIX} component={AfilliatePage} />
            <Route exact path={PUBLIC_PREFIX + PROFILE_PREFIX + AFILLIATE_PREFIX} component={AfilliateProfilePage} />
